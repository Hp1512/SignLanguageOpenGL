...
bool SkinningTechnique::Init()
{
    ...
    if (!AddShader(GL_VERTEX_SHADER, "I:\\SignLanguageOpenGL\\SignLanguageOpenGL\\Shader\\skinning.vs")) {
        return false;
    }

    if (!AddShader(GL_FRAGMENT_SHADER, "I:\\SignLanguageOpenGL\\SignLanguageOpenGL\\Shader\\skinning.fs")) {
        return false;
    }
