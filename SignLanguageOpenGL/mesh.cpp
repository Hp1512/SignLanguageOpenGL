...
void Mesh::VertexBoneData::AddBoneData(int BoneID, float Weight)
{
...
{  
    ...
    int VerticesPerPrim = m_withAdjacencies ? 6 : 3;
...
{    
    ...
    if (pNodeAnim) {
      ...
      //  aiMatrix4x4 ScalingM = aiMatrix4x4(Scaling.x, Scaling.y, Scaling.z);
